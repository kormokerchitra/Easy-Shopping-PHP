...
//$password = "sdf";
//$email = "sdf@r54";
mysqli_query($con, "update product_list set product_name='$product_name', cat_id='$cat_id', cat_name='$cat_name', product_img='$product_img', product_code='$product_code', product_price='$product_price', prod_description='$prod_description', prod_dimension='$prod_dimension', product_size='$product_size', shipping_weight='$shipping_weight', manuf_name='$manuf_name', prod_serial_num='$prod_serial_num' where prod_id='$prod_id'");
