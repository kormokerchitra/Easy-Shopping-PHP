                ...
                <div class="container-fluid pt-5">
                    <div class="row px-xl-5">
                        <div class="btn shadow-none d-flex align-items-center justify-content-between text-white w-100">
                            <h2 class="font-weight-bold text-dark mb-4"><?php echo $title_name; ?></h2>
                        </div>
                                    ...
                                    <tbody class="align-middle">
                                        ...
                                        <?php
                                            ...
                                            for ($i=0; $i < $count; $i++) { 
                                                ...
                                                if($product_rating!=0){
                                                    $reviewStr ="<td class='align-middle'><i class='fas fa-star text-primary'></i><Br/>$product_rating ($rev_count)</td>";
                                                }else{
                                                ...
                                                if($cat_id != "" && $cat_id == $catID){
                                                    ...
                                                    echo "<tr>
                                                        ...
                                                        <td class='align-middle'>
                                                            <a href='detail.php?jsonBody=$jsonBody'><button class='btn btn-sm btn-primary'><i class='fa fa-info-circle'></i></button></a>
                                                        </td>
                                                        <td class='align-middle'>
                                                            <a href='editproduct.php?jsonBody=$jsonBody'><button class='btn btn-sm btn-primary'><i class='fa fa-edit'></i></button></a>
                                                        </td>
                                                        <td class='align-middle'>
                                                            <a href='#'><button class='btn btn-sm btn-primary' type='submit' id='deleteprod' onclick=document.getElementById('$modal1Id').style.display='block'><i class='fa fa-trash'></i></button></a>
                                                        </td>
                                                    </tr>";
                                                                                ...
                                                                                <form name='sentMessage' id='contactForm' method='POST'>
                                                                                    <div class='control-group'>
                                                                                        ...
                                                                                        <div class='row justify-content-center'>
                                                                                            <button class='btn btn-primary py-2 px-4 bg-red' type='submit' id='noButton' name='noButton'>No</button>&nbsp;&nbsp;&nbsp;
                                                                                            <button class='btn btn-primary py-2 px-4 bg-green' type='submit' id='yesButton' name='yesButton'>Yes</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
